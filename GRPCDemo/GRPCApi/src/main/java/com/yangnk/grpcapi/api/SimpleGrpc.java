...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yangnk.grpcapi.api.HelloRequest,
      com.yangnk.grpcapi.api.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.yangnk.grpcapi.api.HelloRequest.class,
      responseType = com.yangnk.grpcapi.api.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yangnk.grpcapi.api.HelloRequest,
      com.yangnk.grpcapi.api.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.yangnk.grpcapi.api.HelloRequest, com.yangnk.grpcapi.api.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.yangnk.grpcapi.api.HelloRequest, com.yangnk.grpcapi.api.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yangnk.grpcapi.api.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yangnk.grpcapi.api.HelloReply.getDefaultInstance()))
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.yangnk.grpcapi.api.HelloRequest request,
        io.grpc.stub.StreamObserver<com.yangnk.grpcapi.api.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.yangnk.grpcapi.api.HelloRequest,
                com.yangnk.grpcapi.api.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractBlockingStub<SimpleBlockingStub> {
     ...
     * </pre>
     */
    public com.yangnk.grpcapi.api.HelloReply sayHello(com.yangnk.grpcapi.api.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractFutureStub<SimpleFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yangnk.grpcapi.api.HelloReply> sayHello(
        com.yangnk.grpcapi.api.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.yangnk.grpcapi.api.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.yangnk.grpcapi.api.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.yangnk.grpcapi.api.HelloWorldProto.getDescriptor();
    }
