...
import com.yangnk.HFNQueue.common.adapter.HfnMessageListenerAdapter;
 ...
 **/
@Configuration
@ComponentScan(basePackages = {"com.yangnk.HFNQueue"})
@PropertySource(value = {"classpath:hfn.properties"})
