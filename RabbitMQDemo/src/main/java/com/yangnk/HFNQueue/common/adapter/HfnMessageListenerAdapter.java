package com.yangnk.HFNQueue.common.adapter;

import com.alibaba.fastjson.JSONObject;
import com.rabbitmq.client.Channel;
import com.yangnk.HFNQueue.common.task.HfnTask;
    ...
    public void onMessage(Message message, Channel channel) throws Exception {
        ...
        try {
            for (int i = 0; i < 3; i++) {
                ...
                Future<String> result = threadPoolExecutor.submit(new HfnTask(experimentInfo));
